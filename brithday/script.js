document.addEventListener('DOMContentLoaded', () => {
    ...
    const timer = setInterval(() => {
        ...
        if (count > 0) {
            ...
            setTimeout(() => {
                ...
                // Attempt auto-play instructions? Usually browsers block unmuted autoplay.
                // We'll rely on the user scrolling or clicking.
            }, 3000);
        }
    }, 1000);
    ...
    document.body.addEventListener('click', () => {
        if (!isPlaying && document.body.classList.contains('scroll-active')) {
            ...
            // audio.play().catch(()=>{}); 
            // We'll leave it to manual control or candle click
        }
    }, { once: true });
